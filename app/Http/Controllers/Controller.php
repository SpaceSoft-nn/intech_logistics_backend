 ...
 *
 * @OA\Schema(
 *     schema="OrderUnitStatusResource",
 *     type="object",
 *     @OA\Property(property="id", type="integer", description="ID специфической даты периода"),
 *     @OA\Property(property="status" , ref="#/components/schemas/OrderUnitStatusEnum", description="Статус заказа"),
 *     @OA\Property(property="created_at", type="string", format="date", description="Дата создание статуса")
 * ),
 *
 * @OA\Schema(
 ...
 *
 * @OA\Schema(
 *     schema="OrderUnitStatusEnum",
 *     type="string",
 *     description="Статусы у заказа",
 *     enum={
 *         "draft",
 *         "published",
 *         "accepted",
