 ...
 *     summary="Добавление исполнителей к заказу *отклик",
 *     tags={"Tender"},
 *     @OA\Parameter(
 *         name="lotTender",
 *         in="path",
 ...
 *
 * @OA\Post(
 *     path="/api/tenders/{lotTenderResponse}/agreements",
 ...
 *
 * @OA\Get(
 *     path="/api/tenders/{lotTender}/agreements",
 *     summary="Вернуть принятый отклик на тендер",
 *     tags={"Tender"},
 *     @OA\Parameter(
 *         name="lotTender",
 *         in="path",
 ...
 *     @OA\Response(
 *         response=200,
 *         description="Запись выбранного отклика успешна возвращена.",
 *         @OA\JsonContent(
 *             @OA\Property(property="data", ref="#/components/schemas/AgreementTenderResource"),
 *             @OA\Property(property="message", type="string", example="Create agreement tender.")
 *         )
 ...
 *
 * @OA\Post(
 *     path="/api/tenders/agreements/{agreementTenderAccept}/accept",
