...
class MatrixDistanceSeed extends Seeder
{
    ...
    private function createMatrix()
    {
        ...
        foreach ($orders as $order) {
            ...
            */
            ...
            $result = MatrixDistance::factory()->create([
                "city_start_gar_id" => $this->getFiaId($adress_start->city),
                "city_end_gar_id" => $this->getFiaId($adress_end->city),
    ...
    private function getFiaId(string $adress) : string
    {
